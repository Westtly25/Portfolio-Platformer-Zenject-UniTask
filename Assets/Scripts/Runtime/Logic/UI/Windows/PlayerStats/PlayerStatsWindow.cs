...
namespace Scripts.UI.Windows.PlayerStats
{
    public class PlayerStatsWindow : AnimatedWindow
    {
        ...
        protected override void Start()
        {
            ...
            _session.StatsModel.InterfaceSelectedStat.Value = CoreGameConfigs.ConfigsInstance.Player.Stats[0].ID;
        ...
        {
            var stats = CoreGameConfigs.ConfigsInstance.Player.Stats;
